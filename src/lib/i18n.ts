...
const dictionaries = {
  en: {
    ...
    added: 'Added',
    removeGitlab: 'Remove GitLab project',
    ...
    runCheckDescription: 'Fetch refs, analyze branches and generate notifications.',
    noEmail: 'No email',
  ...
  zh: {
    ...
    gitlabUrl: 'GitLab 地址',
    gitlabApiKey: 'GitLab API 密钥',
    apiKeySaved: '密钥已保存',
    loadProjects: '载入项目',
    added: '已添加',
    removeGitlab: '移除 GitLab 项目',
    notifyTarget: '通知对象',
    noNotify: '不通知',
    notifySelf: '通知自己',
    notifyBoth: '通知创建者和自己',
    ...
    noBranches: '没有找到分支',
    runCheckDescription: '拉取引用、分析分支并生成通知。',
    noEmail: '不发送邮件',
