...
const dictionaries = {
  en: {
    ...
    triggerCheckNotify: 'Run one check now',
    checkOnlyNoEmail: 'Check only (no email)',
  ...
  zh: {
    ...
    noNotify: '不通知',
    notifySelf: '通知自己',
    notifyBoth: '通知分支创始人和自己',
    autoDeleteEnabled: '自动删除已停更分支',
    autoDeleteHint: '关闭时定时检查仅检查并通知，不执行删除。',
    inspectionOnly: '仅检查',
    checkAndDelete: '检查并删除',
    firstCommit: '首次提交',
    reports: '报告',
    scheduler: '定时调度',
    auditLog: '审计日志',
    ...
    scanAll: '扫描全部',
    runCheckNow: '立即检查',
    triggerCheckNotify: '立即触发一次检查',
    checkOnlyNoEmail: '仅检查，不发送邮件',
    generateReport: '生成报告',
    search: '搜索',
